...
The aim of this analysis is to see whether the mane transcripts retain more of the variants in cosmic than the altervatives transcripts of a gene. There are number of ways to track a COSMIC variants, either genomic position, Genomic mutation identifier (COSV) or Legacy mutation identifier (COSM).
...
for (gene in new_genes){
  ...
  # bind total COSMs to the summary table
  row <- c(gene, "Total exonic COSMs for this gene: ", length(total_COSMs))
  summary_tbl <- rbind(summary_tbl, row)
  
  # loop through transcript list to get number of COSMs then bind this to the summary table
...
colnames(summary_tbl) <- c("Gene", "Transcript", "Number of COSMs")
